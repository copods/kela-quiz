    ...
    switch (props.varient) {
      case 'primary-solid':
        return `bg-primary text-gray-50 ${
          !props.isDisabled &&
          'hover:bg-primaryHover transition ease-in-out delay-75'
      ...
      case 'primary-outlined':
        return `text-gray-primary rounded-md border border-primary bg-white text-primary ${
          !props.isDisabled &&
          'hover:bg-gray-100 transition ease-in-out delay-75'
        } ${
          props.isDisabled &&
      ...
      case 'secondary-solid':
        return `border border-transparent bg-red-500 text-white ${
          !props.isDisabled &&
          'hover:bg-red-700 transition ease-in-out delay-75'
