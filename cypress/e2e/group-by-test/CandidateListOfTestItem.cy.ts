...
describe('Visiting group by test of results page', () => {
  ...
  it('Verify if user able create the test and navigate to group test results page', () => {
    cy.visit('/sign-in')
    cy.get('#email')
      .clear()
      .type('careers@copods.co')
    ...
    cy.get('button#submitButton').should('have.text', cypress.next).click()
  ...
  it('Check if that test is coming on group by test page or not', () => {
    ...
    cy.get('a')
      ...
      .should('have.text', cypress.groupByTest)
      .click()
  ...
  it('check  if back button is going back to group by test page ', () => {
    cy.visit('/sign-in')
    cy.get('#email')
      .clear()
      .type('careers@copods.co')
    ...
    cy.get('#group-by-test-container')
      ...
      .get('#group-by-item-test')
      .click()
    cy.get('#backButtonOfResult').click()
    cy.location('pathname', { timeout: 60000 }).should('include', '/results')
  })
})
