  ...
  return (
    <div className="w-full bg-white shadow p-6 rounded-lg flex flex-col gap-6">
      <div>
        ...
        <input type="text" id="name" name="name" value={name} onChange={(e) => setName(e.target.value)} className="w-full h-11 rounded-lg border border-gray-200 test-base px-3 mt-1" placeholder="Critical Thinking" />
      </div>
      <div>
