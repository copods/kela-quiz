...
const WebCamGetPicture = forwardRef(
  (
    { img, setImg, getFaceCount }: { img: any; setImg: any; getFaceCount: any },
    ref: any
  ) => {
    ...
    const getSnapshot = async (recg = false) => {
...
WebCamGetPicture.displayName = "WebCamGetPicture"
